...
// this function is not in here!!!!! find it in base.html
{
    ...
    if (src_name == "bilibili") {
      ...
      if (vai) {
          ...
          vai.innerHTML = '(Bilibili 无法播放? 请 <a style="color:#F56100;text-decoration:none;" href="https://www.bilibili.com/video/av' + vid +'" target="_blank" >点击这里</a> 跳转至B站内)';
      }
    ...
    // youku
      ...
      if (vai) {
        vai.style.display = "block";
        vai.innerHTML = '(优酷无法播放? 请 <a style="color:#F56100;text-decoration:none;" href="http://v.youku.com/v_show/id_' + vid +'==.html" target="_blank" >点击这里</a> 跳转至优酷站内)';
      }
    }
